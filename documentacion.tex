...
\begin{document}
	...
	Sobre el conjunto de datos de cada caso de estudio se ha aplicado la \textbf{normalización $l^2$}, que consiste en calcular la raíz cuadrada de la suma de los valores absolutos al cuadrado.\\
